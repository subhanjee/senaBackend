...
const accommodationValidation = require('../../validations/accommodation.validation');
...
router
  ...
  .get(auth('accommodation'), validate(accommodationValidation.getAccommodation), accommodationController.getAccommodation)
  .patch(
    auth('accommodation'),
  ...
  .delete(
    auth('accommodation'),
    validate(accommodationValidation.deleteAccommodation),
